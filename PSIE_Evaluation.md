...
## Rapport d'Évaluation — Critères OCDE/CAD : Pertinence, Cohérence et Efficacité
...
| Champ | Détail |
|---|---|
| **Intitulé du programme** | Programme Spécial d'Insertion dans l'Emploi (PSIE) |
...
| **Version** | 1.1 — Complétée sur base documentaire |

---

## RÉSUMÉ EXÉCUTIF

Le **Programme Spécial d'Insertion dans l'Emploi (PSIE)** est une initiative présidentielle lancée au Bénin en juillet 2020, dont l'objectif est de faciliter l'insertion professionnelle de 2 000 jeunes diplômés par an dans les entreprises publiques et privées, à travers la prise en charge totale de leurs salaires par l'État sur une période de deux ans par cohorte.

L'évaluation des trois premiers critères OCDE/CAD, conduite sur la base d'une revue documentaire, aboutit aux constats suivants :

**Pertinence — Élevée.** Le PSIE répond à un besoin structurel documenté : un taux de sous-emploi des jeunes de 72 % (INSAE, 2017), une inadéquation formation-emploi et des réticences des entreprises à embaucher liées aux charges salariales. Le programme est explicitement ancré dans le PAG 2016-2021 et l'objectif de traitement systématique de l'emploi dans l'action gouvernementale. Son modèle centré sur les entreprises est innovant et bien calibré au contexte béninois.

**Cohérence — Élevée.** La chaîne de résultats est logique et cohérente (intrants → activités → extrants → résultats), s'appuyant sur l'infrastructure existante de l'ANPE. Le programme évite les doublons grâce à l'intégration de ses activités dans le PTA de l'ANPE. La cohérence externe avec les politiques nationales d'emploi est forte.
...
1. [Introduction et contexte de l'évaluation](#1-introduction-et-contexte-de-lévaluation)
2. [Description du PSIE](#2-description-du-programme-psie)
...
Le Bénin est confronté à des défis structurels majeurs sur le marché du travail. La population béninoise de moins de 40 ans est estimée à **4,08 millions de personnes**, soit 34 % de la population totale (EMICOV 2015). Ce potentiel démographique reste largement sous-exploité face à un marché du travail caractérisé par un **taux de sous-emploi des jeunes de 72 %** (INSAE, août 2017), une prédominance de l'économie informelle, et une inadéquation structurelle entre l'offre de formation et la demande des entreprises.

C'est dans ce contexte que le Président de la République a annoncé, le 31 juillet 2019, lors de son message à la Nation pour le 59ème anniversaire de l'indépendance du Bénin, l'institutionnalisation du **Programme Spécial d'Insertion dans l'Emploi (PSIE)**. Le programme a été validé par le Conseil des ministres le 10 juin 2020 et officiellement lancé en juillet 2020.

### 1.2 Objet et objectifs de l'évaluation

La présente évaluation est une **évaluation de processus et de mise en œuvre**, conduite sur la base d'une revue documentaire systématique des documents officiels du programme. Elle se concentre sur trois des sept critères OCDE/CAD :

- **La pertinence** : Le programme répond-il aux besoins réels des bénéficiaires et aux priorités nationales ?
- **La cohérence** : Le programme est-il cohérent en lui-même et avec les autres politiques ?
- **L'efficacité** : Le programme atteint-il les objectifs qu'il s'est fixés ?
...
## 2. DESCRIPTION DU PROGRAMME PSIE

### 2.1 Historique et origine du programme

Le PSIE est une **initiative présidentielle** annoncée le 31 juillet 2019 par le Président Patrice Talon lors du 59ème anniversaire de l'indépendance du Bénin. Elle s'inscrit dans une volonté de traitement systématique de la question de l'emploi des jeunes dans le cadre du Programme d'Actions du Gouvernement (PAG 2016-2021).

L'initiative tire les leçons des expériences antérieures de programmes d'emploi (notamment le Programme d'Appui à l'Emploi Salarié - PAES, éditions 2009-2011) et introduit un modèle novateur centré sur les entreprises comme pilier de l'insertion. Le document provisoire du programme a été formulé entre décembre 2019 et mars 2020, validé en juin 2020, et un décret instituant le PSIE a été pris en août 2020.

En février 2025, face aux résultats probants, le Conseil des ministres a autorisé la **prolongation du programme au-delà de son échéance initiale de décembre 2025**.

### 2.2 Objectifs du programme

**Objectif général :**
Faciliter l'insertion professionnelle de **deux mille (2 000) jeunes diplômés par an** dans les entreprises publiques et privées au Bénin.

**Objectifs spécifiques :**
1. **OS1 :** Améliorer l'employabilité des bénéficiaires du programme en vue de leur insertion professionnelle durable dans les nouveaux postes d'emploi créés, grâce aux actions d'immersion et d'encadrement.
2. **OS2 :** Soutenir financièrement la prise en charge totale des salaires des titulaires des nouveaux emplois créés par les entreprises dans le cadre du programme.

### 2.3 Population cible

**Bénéficiaires directs :**
- **Jeunes diplômés chercheurs d'emploi** : Béninois, âgés de 18 à 35 ans, titulaires d'un diplôme de l'enseignement supérieur (BAC professionnel, BTS/DUT, DTS/Licence, Master/Ingénieur), disponibles immédiatement et non en cours de formation.
- **Entreprises publiques et privées** : légalement constituées, ayant exercé au moins une année, à jour vis-à-vis des impôts et affiliées à la CNSS, avec des besoins exprimés en ressources humaines.

**Répartition prévue des chercheurs d'emploi par qualification (par cohorte de 2 000) :**

| Qualification | Proportion | Nombre |
|---|---|---|
| BAC professionnel (BAC technique/professionnel) | 10 % | 200 |
| BTS/DUT (BAC+2) | 30 % | 600 |
| DTS/Licence professionnelle / Maîtrise (BAC+3/4) | 40 % | 800 |
| Master/Ingénieur (BAC+5) | 20 % | 400 |
| **Total** | **100 %** | **2 000** |

**Secteurs éligibles :** Tous secteurs et branches, hors santé, éducation, production agricole, artisanat — sauf pour les emplois de support (administratif, financier, commercial, qualité, R&D). Secteurs prioritaires : agriculture, industrie (agro-transformation, chimie, matériaux de construction, énergies renouvelables, textile), services (tourisme-hôtellerie, TIC).

**Secteurs exclus des emplois directs** (mais éligibles pour fonctions de support) : santé, éducation, production agricole, artisanat.

### 2.4 Zone géographique couverte

**Tout le territoire national de la République du Bénin**, avec une présence de l'ANPE et de ses antennes dans tous les départements.

### 2.5 Composantes et activités principales

| Composante | Description | Résultats attendus |
|---|---|---|
| **Gestion et pilotage** | Mise en place de la plateforme, comités de pilotage et technique, coordination PSIE | Programme opérationnel, gouvernance fonctionnelle |
| **Prospection et enregistrement** | Enregistrement des entreprises et candidats sur la plateforme ; publication des offres | Base de données constituée, offres publiées |
| **Sélection et appariement** | Présélection sur dossiers, évaluation écrite, interviews par panels d'experts, sélection finale par les entreprises | Listes d'aptitude validées, candidats sélectionnés et affectés |
| **Préparation à l'insertion** | Formation de 3-5 jours des candidats (culture d'entreprise, déontologie, savoir-vivre) ; formation des tuteurs/mentors des entreprises | Candidats et entreprises prêts pour l'immersion |
| **Immersion et prise en charge salariale** | Contrats de travail ; paiement des salaires par le Trésor (État tiers-payant) ; suivi mensuel de présence | 2 000 jeunes en emploi par an, salaires versés |
| **Suivi et renforcement des capacités** | Visites terrain, ateliers de renforcement (TRE, déontologie, valorisation du poste) ; suivi semestriel | Allocataires encadrés, indicateurs renseignés |
| **Dispositif post-programme** | Orientation vers l'emploi salarié ou indépendant ; salon annuel de recrutement ; suivi alumni à 6, 12 et 24 mois | Durabilité de l'insertion mesurée |

### 2.6 Cadre institutionnel et acteurs

| Acteur | Rôle |
|---|---|
| **Présidence de la République / BAI** | Autorité de tutelle, financement, mise à disposition de l'Unité de Coordination |
| **Ministère en charge de l'Emploi** | Supervision politique |
| **ANPE** | Agence d'exécution : plateforme, bases de données, conseillers en emploi, réseau territorial |
| **Comité de pilotage (CA ANPE)** | Orientations stratégiques, validation des rapports, approbation des budgets |
| **Comité technique (DG ANPE)** | Validation technique, supervision mensuelle des opérations |
| **Coordination du PSIE** | Coordinateur, spécialiste S-E, administrateur plateforme — gestion opérationnelle quotidienne |
| **Organisations d'employeurs** | Caution morale des entreprises membres (CCIB, CNPB, CONEB, groupements professionnels) |
| **Entreprises bénéficiaires** | Sélection finale des candidats, tuteurs/mentors, encadrement, déclaration CNSS/IRPP |
| **Trésor public** | Paiement direct des salaires sur les comptes des allocataires |

### 2.7 Budget et financement

**Financement : 100 % ressources nationales (budget de l'État béninois)**. Aucune contribution numéraire n'est attendue des entreprises.

**Budget global prévisionnel sur 5 ans : 46,60 milliards FCFA**, dont :

| Rubrique | Part estimée |
|---|---|
| Salaires et charges sociales des allocataires (43,57 milliards) | ~93,5 % |
| Formation et encadrement | ~3 % |
| Fonctionnement et frais de gestion administrative | ~3,5 % |

**Exécution financière cumulative (juillet 2020 – septembre 2025) :**

| Nature de dépense | Prévisions | Réalisations | Taux |
|---|---|---|---|
| Salaires, charges sociales et fiscales | 24,8 milliards FCFA | 18,3 milliards FCFA | ~74 % |
| Fonctionnement et opérations | 3,1 milliards FCFA | 2,25 milliards FCFA | ~72 % |
| **Total** | **~27,9 milliards FCFA** | **~20,6 milliards FCFA** | **79,6 %** |

### 2.8 Cadre logique / Théorie du changement

La théorie du changement du PSIE suit la logique suivante :

**Problème identifié :** Les jeunes diplômés n'accèdent pas à l'emploi en raison de (1) l'inadéquation entre leur profil et les besoins des entreprises, et (2) la réticence des entreprises à embaucher, due aux charges salariales.

**Réponse programmatique :** L'État prend en charge 100 % des salaires pendant la période d'immersion (24 mois), levant ainsi la contrainte financière pour les entreprises, tandis que les jeunes acquièrent une expérience professionnelle encadrée améliorant leur employabilité durable.

| Intrants | Activités | Extrants | Résultats | Impact visé |
|---|---|---|---|---|
| Budget de l'État (46,6 mds FCFA) | Prospection entreprises, sélection candidats | Entreprises enregistrées, offres publiées, candidats insérés | R1 : 2000 jeunes/an mieux qualifiés et insérés | Réduction du chômage et sous-emploi des jeunes au Bénin |
| ANPE (plateforme, RH, réseau) | Prise en charge salariale, encadrement tutorat | Contrats signés, salaires versés | R2 : 2000 jeunes/an rémunérés par l'État | Amélioration de la compétitivité des entreprises |
| Unité de coordination | Suivi mensuel, formation | Rapports de suivi, ateliers réalisés | — | Croissance économique inclusive |
...
|---|---|---|---|
| **Phase 1** | Phase préparatoire | Recrutement de l'équipe d'évaluation ; séance de cadrage avec le commanditaire (ANPE) | ✅ Réalisée |
| **Phase 2** | Élaboration et validation du référentiel d'évaluation | Rédaction du référentiel (contexte, méthodologie, matrice, TdC, outils) ; validation par le Comité de pilotage | ✅ Réalisée |
| **Phase 3** | Collecte et analyse de données | Enquête quantitative (allocataires, groupe témoin, entreprises) ; entretiens individuels et focus groups | 🔲 À réaliser |
...
| N° | Document | Nature | Couverture |
|---|---|---|---|
| **D1** | Prodoc PSIE-BéninF (revu) 03.04.20 | Document de projet (59 pages) | Conception, objectifs, architecture institutionnelle, budget prévisionnel (mars 2020) |
...
|---|---|---|
| Fiche d'analyse de la documentation | Documents additionnels identifiés lors du terrain | Données complémentaires sur les effets et l'efficience |
| Questionnaire structuré (CSPRO) | Allocataires, groupe témoin, entreprises | Données quantitatives sur l'emploi, les revenus, les comportements d'embauche |
...
|---|---|---|---|
| Jeunes **allocataires** du PSIE | 145 | + 29 | **174 allocataires** |
| Jeunes **non-allocataires** (groupe témoin) | — | ratio 1:1,8 | **313 non-allocataires** |
...
|---|---|---|---|
| **Comité de gouvernance et de pilotage** | Directeur Général de l'ANPE ; Coordonnateur du PSIE | Entretien individuel | 1 entretien (2 personnes) |
| **Acteurs de mise en œuvre** | Spécialiste S-E PSIE ; Administrateur de la plateforme ; Assistante administrative ; Assistant financier | Focus group | 1 focus group (4 personnes) |
...
| Limite | Nature | Implications pour les constats |
|---|---|---|
| **Absence de données primaires** | Méthodologique | Les perceptions des bénéficiaires, des entreprises et des acteurs opérationnels ne sont pas captées. Les jugements reposent exclusivement sur les données officielles disponibles. |
| **Absence de groupe de comparaison** | Méthodologique | Il est impossible d'isoler l'effet causal net du PSIE sans groupe témoin. Les constats d'efficacité portent sur les extrants (réalisations) et non sur les effets (changements attribuables). |
| **Biais de publication dans les rapports officiels** | Biais de source | Les documents officiels tendent à valoriser les succès. Les taux d'insertion durable post-programme, les abandons et les difficultés de mise en œuvre sont sous-documentés dans les sources disponibles. |
...
| N° | Recommandation | Priorité | Acteur responsable | Échéance |
|---|---|---|---|---|
| R1 | Conduire une analyse actualisée de l'adéquation formation-emploi (par filière et région) pour ajuster les quotas de qualifications par cohorte aux besoins réels actuels du marché. | Haute | Coordination PSIE / ANPE / INSAE | Court terme (2026) |
| R2 | Explorer l'extension du plafond d'âge à 40 ans pour les chômeurs de longue durée, en cohérence avec la réalité du chômage structurel béninois. | Moyenne | Comité de pilotage / Ministère de l'Emploi | Moyen terme |

#### Recommandations relatives à la Cohérence

| N° | Recommandation | Priorité | Acteur responsable | Échéance |
|---|---|---|---|---|
| R3 | Formaliser un avenant au cadre logique et au budget pour intégrer la révision de la grille salariale et la prolongation du programme au-delà de 2025, avec des cibles actualisées. | Haute | Coordination PSIE / BAI | Court terme (2026) |
| R4 | Mettre en place un mécanisme formel de coordination avec les autres programmes d'emploi (FNPEEJ, autres) pour éviter les doublons de bénéficiaires et les incohérences dans les conditions d'accès. | Moyenne | ANPE / Ministère de l'Emploi | Moyen terme |

#### Recommandations relatives à l'Efficacité

| N° | Recommandation | Priorité | Acteur responsable | Échéance |
|---|---|---|---|---|
| R5 | Développer une **stratégie de déconcentration géographique** ciblant les 10 départements sous-représentés, notamment les Collines, le Couffo, la Donga, l'Alibori et l'Atacora — en s'appuyant sur les antennes de l'ANPE et des campagnes de sensibilisation mobiles — avec pour objectif d'**augmenter la part des insertions hors Littoral/Atlantique à au moins 25 % d'ici fin 2026** (contre 14,5 % au 30 septembre 2025). | **Haute** | Coordination PSIE / ANPE | Court terme (2026) |
| R6 | Renforcer le dispositif de prospection dans les secteurs sous-représentés (TIC, hôtellerie-restauration-tourisme, énergies renouvelables) en établissant des partenariats ciblés avec les associations professionnelles de ces secteurs. | Haute | Coordination PSIE / ANPE | Court terme (2026) |
| R7 | Formaliser et opérationnaliser le **suivi des alumni** (bénéficiaires post-programme à 6, 12 et 24 mois) pour renseigner les taux de rétention et alimenter une future évaluation d'impact. | **Haute** | Coordination PSIE / Spécialiste S-E | Court terme (2026) |
| R8 | Renforcer les mécanismes de suivi et de sanction des entreprises ne respectant pas les clauses contractuelles (notamment les licenciements injustifiés pendant la période d'immersion). | Haute | Comité technique PSIE / ANPE | Court terme (2026) |
| R9 | Mettre en place un système de collecte de la satisfaction des bénéficiaires et des entreprises (enquête annuelle) pour compléter le tableau de bord des indicateurs. | Moyenne | Spécialiste S-E / Coordination PSIE | Moyen terme |
...
5. **Absence d'entretiens** : Les constats reposent exclusivement sur les documents disponibles, sans recueil des perceptions des bénéficiaires, des entreprises ou des équipes de mise en œuvre.
...
| Critère | Question évaluative | Éléments de preuve mobilisés | Source | Jugement |
|---|---|---|---|---|
| Pertinence | QE1.1 — Adéquation aux besoins | Taux de sous-emploi 72 % ; demande des entreprises ; profils ciblés alignés | Prodoc §2 ; INSAE 2017 | **Élevé** |
| Pertinence | QE1.2 — Alignement priorités nationales | Ancrage PAG 2016-2021 ; initiative présidentielle ; PNE 2017-2026 | Prodoc §1 ; Rapport MO (conclusion) | **Élevé** |
| Pertinence | QE1.3 — Diagnostic pertinent et actuel | Modèle centré entreprises ; mécanisme tiers-payant ; prolongation 2025 | Prodoc §3 ; Rapport MO (conclusion) | **Élevé** |
| Cohérence | QE2.1 — Logique interne | Cadre logique R1→OS1, R2→OS2 ; hypothèses explicitées ; budget cohérent | Cadre Logique ; Prodoc §9 | **Élevé** |
| Cohérence | QE2.2 — Cohérence avec PAG/PNE | Ancrage PAG explicite ; ANPE comme agence d'exécution (cohérence institutionnelle) | Prodoc §1, §8 | **Élevé** |
| Cohérence | QE2.3 — Chevauchements | Intégration PTA ANPE ; pas de doublon documenté ; précédent PAES assumé | Prodoc §8 ; Rapport MO | **Élevé** |
| Efficacité | QE3.1 — Atteinte objectifs insertions | 9 263 insertions (juillet 2020 – sept. 2025) ; dépassement cible initiale 8 000 | Rapport MO Tableau 2 | **Élevé** |
| Efficacité | QE3.2 — Atteinte des extrants 2025 | 111,8 % entreprises ; 85,3 % insertions ; 87,7 % postes publiés | Rapport MO Tableau 1 | **Moyen à élevé** |
| Efficacité | QE3.3 — Facteurs d'influence | GDIZ, réseaux sociaux, CCIB (+) ; concentration géographique, TIC/hôtellerie, abandon (-) | Rapport MO (difficultés) | Mixte |
| Efficacité | QE3.4 — Qualité S-E | Plateforme, tableaux de bord, rapports ; mais absence données rétention post-programme | Prodoc §7 ; Rapport MO | **Moyen** |

### Annexe 2 — Liste des documents consultés

| N° | Intitulé du document | Type | Auteur/Institution | Date | Dossier |
|---|---|---|---|---|---|
| 1 | Prodoc PSIE-BéninF (revu) 03.04.20.pdf | Document de programme | Gouvernement du Bénin / Présidence | Mars 2020 | `docs/psie/01_document_projet/` |
| 2 | Cadre Logique PSIE.pdf | Cadre de résultats | Coordination PSIE / ANPE | 2020 | `docs/psie/03_cadre_logique/` |
| 3 | Rapport actualisé de mise en œuvre du PSIE juil. 2020 – sept. 2025 | Rapport d'activités | Coordination PSIE / ANPE | Octobre 2025 | `docs/psie/02_rapport_mise_en_oeuvre/` |

### Annexe 3 — Glossaire des termes clés

| Terme | Définition |
|---|---|
| **Pertinence** | Mesure dans laquelle les objectifs du programme correspondent aux besoins des bénéficiaires et aux priorités nationales. |
| **Cohérence interne** | Solidité de la logique d'intervention propre au programme (enchaînement intrants → activités → extrants → résultats). |
| **Cohérence externe** | Compatibilité du programme avec d'autres politiques, programmes et institutions. |
| **Efficacité** | Mesure dans laquelle le programme a atteint ou est en voie d'atteindre ses objectifs fixés. |
| **Allocataire** | Jeune chercheur d'emploi bénéficiaire du PSIE, placé dans une entreprise et dont le salaire est pris en charge par l'État. |
| **Extrant** | Produit direct des activités du programme (ex. nombre de personnes insérées en emploi). |
| **Tiers-payant** | Mécanisme par lequel l'État (via le Trésor) verse directement le salaire aux allocataires pour le compte de l'entreprise. |
| **PSIE** | Programme Spécial d'Insertion dans l'Emploi (Bénin). |
| **ANPE** | Agence Nationale Pour l'Emploi (Bénin) — agence d'exécution du PSIE. |
...
### Annexe 4 — Critères OCDE/CAD reportés à la Phase 2
...
*Document préparé conformément aux **Normes de qualité pour l'évaluation du développement** du CAD-OCDE (2010).*

*Sources principales : Prodoc PSIE-BéninF (revu) mars 2020 · Cadre Logique PSIE · Rapport actualisé de mise en œuvre du PSIE juillet 2020 – septembre 2025 (octobre 2025) · Base de données PSIE, septembre 2025.*
